...
<img src="p8105_hw5_jz3297_files/figure-gfm/unnamed-chunk-15-1.png" width="90%" />
...
estimate_all_plot =
  ...
  geom_point() +
  stat_smooth(method = "lm", se = FALSE, size = 0.2, alpha = 0.5, color = "red") +
  scale_x_continuous(limits = c(0,6), breaks = seq(0,6,1)) +
  scale_y_continuous(limits = c(-1,6), breaks = seq(-1,6,1)) +
  labs(
    title = "Mean estimate of mu hat vs. true mu",
    x = "True mu",
    y = "Mean estimate of mu hat"
  )
```
...
<img src="p8105_hw5_jz3297_files/figure-gfm/unnamed-chunk-16-1.png" width="90%" />
...
estimate_rej_plot =
  ...
  labs(
    title = "Mean estimate of mu hat (rejected) vs. true mu",
    x = "True mu",
    y = "Mean estimate of mu hat (rejected)"
  )
```
...
<img src="p8105_hw5_jz3297_files/figure-gfm/unnamed-chunk-17-1.png" width="90%" />
