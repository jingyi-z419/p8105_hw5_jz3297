...
* For mu = 0,1,2,3, the sample average of mu for which the null is rejected departures from the true value of mu. For mu = 4,5,6, the sample average of mu for which the null is rejected is approximately equal to the true value of mu. This is because the power of the test increases as the effect size increases. In other words, the probability that a false null hypothesis is rejected increases as mu increases (effect size).
